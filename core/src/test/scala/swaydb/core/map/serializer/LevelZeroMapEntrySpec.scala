...
class LevelZeroMapEntrySpec extends TestBase {
  ...
  "MapEntryWriterLevel0 & MapEntryReaderLevel0" should {
    ...
    "write Put key value" in {
      runThis(100.times) {
        val put = Memory.put(1, randomStringOption, randomDeadlineOption, randomNextTimeOption)
    ...
    "write remove key-value" in {
      runThis(100.times) {
        val remove = Memory.remove(1, randomDeadlineOption, randomNextTimeOption)
    ...
    "write Update key value" in {
      runThis(100.times) {
        val update = Memory.update(1, randomStringOption, randomDeadlineOption, randomNextTimeOption)
    ...
    "write, remove & update key-value" in {
      runThis(100.times) {
        ...
        val put1 = Memory.put(1, randomStringOption, randomDeadlineOption, randomNextTimeOption)
        val put2 = Memory.put(2, randomStringOption, randomDeadlineOption, randomNextTimeOption)
        val put3 = Memory.put(3, randomStringOption, randomDeadlineOption, randomNextTimeOption)
        val put4 = Memory.put(4, randomStringOption, randomDeadlineOption, randomNextTimeOption)
        val put5 = Memory.put(5, randomStringOption, randomDeadlineOption, randomNextTimeOption)

        val remove1 = Memory.remove(1, randomDeadlineOption, randomNextTimeOption)
        val remove2 = Memory.remove(2, randomDeadlineOption, randomNextTimeOption)

        val update1 = Memory.update(3, randomStringOption, randomDeadlineOption, randomNextTimeOption)
