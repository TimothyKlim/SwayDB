...
//                fromKey = 10,
//                toKey = 15,
//                fromValue = oldKeyValue.fromValue.map(KeyValueMerger(newKeyValue.rangeValue, _, atLeastTimeLeft).assertGet),
//                rangeValue = KeyValueMerger(newKeyValue.rangeValue, oldKeyValue.rangeValue, atLeastTimeLeft).assertGet
//              ),
//              Memory.Range(
//                fromKey = 15,
//                toKey = 20,
...
//                      Some(KeyValueMerger(newKeyValue.fromValue.getOrElse(newKeyValue.rangeValue), oldFromValue, atLeastTimeLeft).assertGet)
//                    case None =>
//                      newKeyValue.fromValue match {
//                        case Some(newFromValue) =>
//                          Some(KeyValueMerger(newFromValue, oldKeyValue.fromValue.getOrElse(oldKeyValue.rangeValue), atLeastTimeLeft).assertGet)
//                        case None =>
//                          None
//                      }
//                  },
...
//                fromKey = 11,
//                toKey = 15,
//                fromValue = newKeyValue.fromValue.map(KeyValueMerger(_, oldKeyValue.rangeValue, atLeastTimeLeft).assertGet),
//                rangeValue = KeyValueMerger(newKeyValue.rangeValue, oldKeyValue.rangeValue, atLeastTimeLeft).assertGet
//              ),
//              Memory.Range(
//                fromKey = 15,
