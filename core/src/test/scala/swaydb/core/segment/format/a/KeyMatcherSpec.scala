...
//import swaydb.core.segment.format.a.entry.reader.lazyvalue.{LazyRangeValueReader, LazyValueReader}
...
//    Put(int, None, LazyValueReader(Reader(Slice.emptyBytes), 0, 0), None, 0, 0, 0, 0, 0)
//
...
//      Range(tuple._1, tuple._2, LazyRangeValueReader(Reader(Slice.emptyBytes), 0, 0), 0, 0, 0, 0, 0)
//
...
//      Group(
//        tuple._1,
//        MaxKey.Fixed(tuple._2), new GroupDecompressor(Reader(Slice.emptyBytes), 0), Reader(Slice.emptyBytes), 0, 0, 0, 0, 0, None)
//
