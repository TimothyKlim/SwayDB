...
//      test(Slice(Transient.Range[FromValue, RangeValue](1, 10, None, Value.Update(None, None))))
...
//      foundKeyValue1.getOrFetchValue.assertGetOpt shouldBe keyValues.head.value
...
//      foundKeyValue2.getOrFetchValue.assertGetOpt shouldBe keyValues(1).value
...
//      foundKeyValue3.getOrFetchValue.assertGetOpt shouldBe keyValues(2).value
...
//      foundKeyValue4.getOrFetchValue.assertGetOpt shouldBe keyValues(3).value
...
//      foundKeyValue5.getOrFetchValue.assertGetOpt shouldBe keyValues(4).value
...
//      foundKeyValue2.getOrFetchValue.assertGetOpt shouldBe keyValues.head.value
...
//      foundKeyValue3.getOrFetchValue.assertGetOpt shouldBe keyValues(1).value
...
//      foundKeyValue4ToKey.getOrFetchValue.assertGetOpt shouldBe fourth.value //lower is Self
...
//      foundKeyValue1.getOrFetchValue.assertGetOpt shouldBe keyValues(1).value
...
//      foundKeyValue3.getOrFetchValue.assertGetOpt shouldBe keyValues(3).value
...
//      foundKeyValue4FromKey.getOrFetchValue.assertGetOpt shouldBe fourth.value //lower is Remove
