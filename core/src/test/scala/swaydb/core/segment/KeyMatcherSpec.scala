...
//import swaydb.core.segment.format.a.entry.reader.matchers.{PutReader, RangeReader}
...
//    Put(int, None, PutReader.lazyValueReader(Reader(Slice.emptyBytes), 0, 0), 0, 0, 0, 0, 0)
//
...
//      */
//
//    implicit def toRange(tuple: (Int, Int)): Range =
//      Range(tuple._1, tuple._2, RangeReader.lazyRangeValueReader(Reader(Slice.emptyBytes), 0, 0), 0, 0, 0, 0, 0)
//
//    implicit def toSomeRange(tuple: (Int, Int)): Option[Range] =
//      Some(tuple)
//  }
//
...
//      Group(tuple._1, MaxKey.Fixed(tuple._2), new GroupDecompressor(Reader(Slice.emptyBytes), 0), Reader(Slice.emptyBytes), 0, 0, 0, 0, 0, None)
//
//    implicit def toGroupRange(tuple: (Int, (Int, Int))): Group =
//      Group(tuple._1, MaxKey.Range(tuple._2._1, tuple._2._2), new GroupDecompressor(Reader(Slice.emptyBytes), 0), Reader(Slice.emptyBytes), 0, 0, 0, 0, 0, None)
//
