...
import swaydb.core.segment.format.a.entry.id.EntryToEntryFormatBinding
...
object EntryWriter {
  ...
  /**
    ...
    *
    * @param bind                    [[EntryFormat]] for this key-value's type.
  ...
  def write[T <: KeyValue.WriteOnly](current: T,
                                     ...
                                     compressDuplicateValues: Boolean)(implicit bind: EntryToEntryFormatBinding[T]): (Slice[Byte], Option[Slice[Byte]], Int, Int) = {
    current.previous flatMap {
          ...
          case (_, remainingBytes) if remainingBytes.isEmpty =>
            ...
            val (indexBytes, valueBytes, valueStartOffset, valueEndOffset) =
              TimeWriter.write(
                ...
                entryId = bind.entryFormat.format.keyFullyCompressed,
          ...
          case (commonBytes, remainingBytes) =>
            val (indexBytes, valueBytes, valueStartOffset, valueEndOffset) =
              TimeWriter.write(
                ...
                currentTime = currentTime,
                compressDuplicateValues = compressDuplicateValues,
                entryId = bind.entryFormat.format.keyPartiallyCompressed,
      ...
      val (indexBytes, valueBytes, valueStartOffset, valueEndOffset) =
        TimeWriter.write(
          ...
          currentTime = currentTime,
          compressDuplicateValues = compressDuplicateValues,
          entryId = bind.entryFormat.format.keyUncompressed,
